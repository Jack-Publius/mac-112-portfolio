...
```{r}
# labs(x = "Rating", y = "Number of hikes") The name of the y-axis becomes to "Number of hikes" that of the x-axis become to "rating"
ggplot(hikes, aes(x = rating)) +
  geom_bar() +
...
```{r}
# Change in geom_bar(color = "orange", fill = "blue") The 
ggplot(hikes, aes(x = rating)) +
