...
-Bar chart. There are only three kinds of rating-moderate, difficult and easy. 
b.  What about a visualization of the *quantitative* `elevation` variable?
-A Histogram. Because histogram can describe the contrast between different elevations.
...
-   What's the purpose of the `+`? When do we use it?
 It is used to add new features to the graph. We used it when we need to make changes to the basic graph.

-   We added the bars using `geom_bar()`? Why "geom"?
It stands for we use the geometric shape  in the bar chart

-   What does `labs()` stand for?
Used to modify axis

-   What's the difference between `color` and `fill`?
"fill" will decide the main color of the graph; and "color" will decide the color of only the frame.
...
Difficult, easy and moderate categories.
-   **variability between categories**: Are observations evenly spread out among the categories, or are some categories more common than others?
The moderate category is the most common one, which is much more common than others
